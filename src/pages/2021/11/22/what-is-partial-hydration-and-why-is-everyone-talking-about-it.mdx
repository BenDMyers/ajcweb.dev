---
canonicalURL: "https://ajcwebdev.com/2021/11/22/what-is-partial-hydration-and-why-is-everyone-talking-about-it"
...
tags: [ "Partial Hydration", "Islands", "Performance" ]
image: "https://cdn.hashnode.com/res/hashnode/image/upload/v1647325549946/zGqGpuUMS.jpg"
...
![02-comparison-chart-of-different-rendering-techniques](https://res.cloudinary.com/practicaldev/image/fetch/s--CBMFinmx--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://developers.google.com/web/updates/images/2019/02/rendering-on-the-web/infographic.png)
...
Alternatively, you can use a shortcode that includes `render` and the hydration option you want to select. The default for all components is `eager` to mirror how previous component-based frameworks operate.
