...
description: "Astro is a web framework that supports the Islands Architecture and includes integrations for React, Preact, Svelte, Vue, SolidJS, AlpineJS and Lit."
...
It supports a variety of UI integrations including React, Preact, Svelte, Vue, SolidJS, AlpineJS and Lit. The framework deserves a fair amount of credit for bringing partial hydration and the concept of "Islands of Interactivity" to the mainstream web development conversation.

### Partial Hydration

I have an [entirely separate, lengthy article](https://ajcwebdev.com/what-is-partial-hydration-and-why-is-everyone-talking-about-it) about this, but here's the summary. The conversation had been present but on the fringes for well over a decade. The first framework that fully supported these techniques, Marko, was created in 2014 but remained the odd duck out until around 2019.
...
All the code for this tutorial can be found [on my GitHub](https://github.com/ajcwebdev/a-first-look/tree/main/astro).
