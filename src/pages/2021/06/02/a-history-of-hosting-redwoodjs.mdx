---
canonicalURL: "https://community.redwoodjs.com/t/a-history-of-hosting-redwoodjs-how-the-universal-deployment-machine-was-built/2168"
title: "a history of hosting redwood"
description: "RedwoodJS was first architected to run statically on a CDN with JavaScript sending requests to a serverless GraphQL handler typically deployed on AWS Lambda via Netlify Functions."
publishDate: "2021-06-02"
tags: [ "Redwood", "Lambda", "PM2", "Serverless" ]
image: "https://dev-to-uploads.s3.amazonaws.com/uploads/articles/hk00mtlotvtfrkmsrcfg.jpg"
...
However, there's no inherent reason a Redwood app has to be deployed this way. This led many to wonder and others to experiment with different methods of deploying the frontend and API.
