---
canonicalURL: "https://ajcwebdev.com/2021/04/21/can-i-use-mongodb-with-prisma-yet/"
...
tags: [ "Prisma", "MongoDB", "Atlas", "ORM" ]
image: "https://dev-to-uploads.s3.amazonaws.com/uploads/articles/c53lwyayptdahtrf5qul.png"
...
- [Deploy Database on MongoDB Atlas](#deploy-database-on-mongodb-atlas)
...
> ___All of this project's code can be found in the [First Look monorepo](https://github.com/ajcwebdev/a-first-look/tree/main/backend/prisma-mongo-atlas/) on my GitHub.___
