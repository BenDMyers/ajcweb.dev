---
canonicalURL: "https://ajcwebdev.com/2021/08/08/a-first-look-at-slinkity/"
...
tags: [ "Slinkity", "Eleventy", "Vite", "React" ]
image: "https://dev-to-uploads.s3.amazonaws.com/uploads/articles/syzdvqbf21uknw7a4pf4.jpeg"
...
Slinkity allows you to insert components into pages with shortcodes such as, `{% react './path/to/Hello.jsx' %}`. Because component-driven pages are hydrated on the client, dynamic state management works in both development and production. It aims to unify two competing camps in the current web development community:
...
Slinkity is in early alpha and not recommended for production use. You can report issues or log bugs [here](https://github.com/Holben888/slinkity/issues). You can find the example code for this project [on my GitHub](https://github.com/ajcwebdev/a-first-look/tree/main/slinkity).
