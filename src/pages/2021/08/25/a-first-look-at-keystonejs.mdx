---
canonicalURL: "https://ajcwebdev.com/2021/08/25/a-first-look-at-keystonejs/"
...
tags: [ "KeystoneJS", "Prisma", "GraphQL", "CMS" ]
image: "https://dev-to-uploads.s3.amazonaws.com/uploads/articles/t154djw4rn2nk4xs5o59.png"
layout: "@/layouts/BlogPost"
---

> ___All of this project's code can be found in the [First Look monorepo](https://github.com/ajcwebdev/a-first-look/tree/main/backend/keystonejs/) on my GitHub.___
...
You can follow the first half of [this guide](https://ajcwebdev.com/2021/07/17/a-first-look-at-postgraphile-with-railway) to see how to spin up the database. The only important difference is when you copy your connection string from Railway, change the first part from `postgresql://` to `postgres://`.
