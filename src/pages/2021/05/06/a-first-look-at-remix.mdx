...
export let loader = () => {
  let data = {
    resources: [
      ...
      { name: "Example Repo", url: "https://github.com/ajcwebdev/a-first-look/tree/main/remix" }
    ]
  }
  return json(data)
}
