---
canonicalURL: "https://ajcwebdev.com/2021/05/09/a-first-look-at-amplify-with-vite"
...
tags: [ "AWS", "Amplify", "React", "Vite" ]
image: "https://dev-to-uploads.s3.amazonaws.com/uploads/articles/fw4ka27ogxkv4g5nd0p9.jpg"
...
> ___All of this project's code can be found in the [First Look monorepo](https://github.com/ajcwebdev/a-first-look/tree/main/deployment/aws-amplify/) on my GitHub.___
...
You need a React app, which means first you have to create one. You could do the sensible thing and use a tool literally called [create-react-app](https://reactjs.org/docs/create-a-new-react-app.html), or you could listen to a random person on the internet and use this thing you've never heard of and have no idea how to pronounce. If you're not convinced you can refer to [this blog post](https://ajcwebdev.com/2021/03/05/a-first-look-at-vite) from the aforementioned random person on the internet.
