---
canonicalURL: "https://ajcwebdev.com/2021/05/02/a-first-look-at-aws-sam/"
...
tags: [ "AWS", "SAM", "CloudFormation", "S3" ]
image: "https://dev-to-uploads.s3.amazonaws.com/uploads/articles/g81nl212agszuv8kxj6i.jpg"
...
> ___All of this project's code can be found in the [First Look monorepo](https://github.com/ajcwebdev/a-first-look/tree/main/deployment/aws-sam/) on my GitHub.___

## Introduction

AWS [Serverless Application Model (SAM)](https://aws.amazon.com/serverless/sam/) is an open-source framework for building serverless applications. It provides shorthand syntax to express functions, APIs, databases, and event source mappings. [Much like AWS CDK](https://ajcwebdev.com/2021/04/30/a-first-look-at-aws-cdk), SAM transforms and expands its own syntax into CloudFormation syntax during deployment.
