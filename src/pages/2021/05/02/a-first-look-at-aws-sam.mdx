...
description: "AWS Serverless Application Model (SAM) is an open-source framework for building serverless applications that provides shorthand syntax to express common cloud resources."
...
The code for this article can be found on my [GitHub](https://github.com/ajcwebdev/a-first-look/tree/main/sam).
