---
canonicalURL: "https://ajcwebdev.com/2021/03/05/a-first-look-at-vite/"
title: "a first look at vite"
description: "Vite is a frontend build tool and open source project created by Evan You. It increases development speed with ESBuild and serves native ES modules by default."
publishDate: "2021-03-05"
updatedDate: "2023-05-23"
tags: [ "Vite", "Vue", "esbuild", "JavaScript", "Netlify" ]
image: "https://cdn.hashnode.com/res/hashnode/image/upload/v1655028538741/dS1EWbVGP.png"
...
> ___All of this project's code can be found in the [First Look monorepo](https://github.com/ajcwebdev/a-first-look/tree/main/frontend/vite/) on my GitHub.___
