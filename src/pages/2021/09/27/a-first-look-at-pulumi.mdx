...
In this tutorial, we'll show you how to write a Pulumi program that creates a serverless app serving static content with dynamic routes in AWS Lambda. All the code for this example can be found [on my GitHub](https://github.com/ajcwebdev/a-first-look/tree/main/pulumi).
