---
canonicalURL: "https://ajcwebdev.com/2021/09/06/a-first-look-at-aws-fargate/"
title: "a first look at aws fargate"
description: "Fargate is an AWS service for running containers on ECS without managing servers or clusters of EC2 instances."
publishDate: "2021-09-06"
tags: [ "AWS", "Fargate", "ECS", "Docker" ]
image: "https://cdn.hashnode.com/res/hashnode/image/upload/v1655101390111/vBEb8CN4j.png"
...
> ___All of this project's code can be found in the [First Look monorepo](https://github.com/ajcwebdev/a-first-look/tree/main/deployment/aws-fargate/) on my GitHub.___
...
* Install and verify the [ECS CLI](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ECS_CLI.html)
* Configure an [IAM role](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html)
* Set up a [cluster](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/clusters.html) with a [security group](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/get-set-up-for-amazon-ecs.html#create-a-base-security-group)
* Deploy a [service](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs_services.html) with [tasks](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_definitions.html) using the [Fargate launch type](https://docs.aws.amazon.com/AmazonECS/latest/userguide/launch_types.html)
...
Wow that took a long time. Should have just used [Fly](https://fly.io/) or [Flightcontrol](https://Flightcontrol.dev/).