---
canonicalURL: "https://ajcwebdev.com/2021/09/02/a-first-look-at-serverless-cloud/"
...
tags: [ "Serverless", "Cloud", "Hosting", "Deployment" ]
image: "https://dev-to-uploads.s3.amazonaws.com/uploads/articles/fgek5skr4ix79m6hbwao.png"
...
- [Setup](#setup)
  - [Install Cloud CLI](#install-cloud-cli)
  - [Initialize Service](#initialize-service)
  - [Deploy to Staging Environment](#deploy-to-staging-environment)
- [Index Entry File](#index-entry-file)
  - [getTodos Function](#gettodos-function)
  - [GET Todos](#get-todos)
  - [POST Updates to a Todo](#post-updates-to-a-todo)
  - [DELETE a Todo](#delete-a-todo)
  - [Custom Error Handler Middleware](#custom-error-handler-middleware)
  - [Check for Overdue Todos Hourly](#check-for-overdue-todos-hourly)
- [Sample Todos](#sample-todos)
- [Tests](#tests)
- [Static Assets](#static-assets)
- [Modify HTML Index File and Deploy to Production](#modify-html-index-file-and-deploy-to-production)
- [Dashboard](#dashboard)
  - [Services](#services)
  - [Instances](#instances)
  - [Metrics](#metrics)
...
> ___All of this project's code can be found in the [First Look monorepo](https://github.com/ajcwebdev/a-first-look/tree/main/deployment/serverless-cloud/) on my GitHub.___
