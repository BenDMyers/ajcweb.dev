...
The code for this article is available [on my GitHub](https://github.com/ajcwebdev/a-first-look/tree/main/docker) and the container image can be found on the [GitHub Container Registry](https://github.com/ajcwebdev/ajcwebdev-docker/pkgs/container/ajcwebdev-docker) and [Docker Hub](https://hub.docker.com/r/ajcwebdev/ajcwebdev-docker).
