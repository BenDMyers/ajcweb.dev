...
Colin didn't continue to maintain the project and essentially abaonded it. [__Alex "KATT" Johansson__](https://twitter.com/alexdotjs) then found the repo after finding a tweet by Colin with a small proof of concept containg two to three files. Alex decided to fork it rather than do his own thing since he hoped he wouldn't be alone.

Having already contributed to Blitz, the idea already resonated with the approach he was looking for, especially the datalayer. Alex has been maintaining the project ever since. It has gained a large cult following in the time since Alex took over the project and his leadership has been so inextricably integral to the project that many assume that he created the project.
