...
In this example we will use the Vercel starter to make Fetch requests containing GraphQL queries. All the code for this example can be found [on my GitHub](https://github.com/ajcwebdev/ajcwebdev-remix).
